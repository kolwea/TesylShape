...
public class Face {
    ...
    private void setupPoints() {
        ...
        points.get(1).setPosition(new Vector(face.getMinWidth() / 3, 50));
        points.get(0).setPosition(new Vector(face.getMinWidth()/3 + 5, face.getMinHeight()/3));
        points.get(3).setPosition(new Vector(face.getMinWidth() / 3 * 2, 50));
        points.get(2).setPosition(new Vector(50, face.getMinHeight() / 3 * 2));
